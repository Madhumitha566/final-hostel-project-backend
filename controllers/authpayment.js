 ...
 export const makePayment = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `https://frontendurl-final-project.netlify.app/payment-success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `https://frontendurl-final-project.netlify.app/payment-cancel`,
